...
import com.erestaurant.erestaurantapp.config.EmbeddedKafka;
...
@WithMockUser
@EmbeddedKafka
class ERestaurantAppKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/e-restaurant-app-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/e-restaurant-app-kafka/consume")
