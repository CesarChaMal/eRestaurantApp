...
public class Admin implements Serializable, Persistable<String> {
    ...
    private Set<AppAd> ads = new HashSet<>();
    ...
    public Set<AppAd> getAds() {
        return this.ads;
    }

    public void setAds(Set<AppAd> appAds) {
        if (this.ads != null) {
            this.ads.forEach(i -> i.setAdmin(null));
        }
        if (appAds != null) {
            appAds.forEach(i -> i.setAdmin(this));
        }
        this.ads = appAds;
    }

    public Admin ads(Set<AppAd> appAds) {
        this.setAds(appAds);
        return this;
    }

    public Admin addAds(AppAd appAd) {
        this.ads.add(appAd);
        appAd.setAdmin(this);
        return this;
    }

    public Admin removeAds(AppAd appAd) {
        this.ads.remove(appAd);
        appAd.setAdmin(null);
        return this;
    }
