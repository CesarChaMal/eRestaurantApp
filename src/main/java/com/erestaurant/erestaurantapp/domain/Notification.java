...
public class Notification implements Serializable, Persistable<String> {
    ...
    public void setType(NotificationType notificationType) {
        ...
        this.typeId = notificationType != null ? notificationType.getId() : null;
    }
    ...
    public Notification restaurant(Restaurant restaurant) {
    ...
    public void setTypeId(String notificationType) {
        this.typeId = notificationType;
    }
