...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Categories}.
 */
@RestController
@RequestMapping("/api")
public class CategoriesResource {
    ...
    public Mono<List<CategoriesDTO>> searchCategories(@RequestParam String query) {
        log.debug("REST request to search Categories for query {}", query);
        return categoriesService.search(query).collectList();
    }
}
