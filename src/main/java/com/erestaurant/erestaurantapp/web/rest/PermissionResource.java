...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Permission}.
 */
@RestController
@RequestMapping("/api")
public class PermissionResource {
    ...
    public Mono<List<PermissionDTO>> searchPermissions(@RequestParam String query) {
        log.debug("REST request to search Permissions for query {}", query);
        return permissionService.search(query).collectList();
    }
}
