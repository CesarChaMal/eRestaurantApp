...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Close}.
 */
@RestController
@RequestMapping("/api")
public class CloseResource {
    ...
    private static final String ENTITY_NAME = "close";
    ...
    /**
     * {@code SEARCH  /_search/closes?query=:query} : search for the close corresponding
     * to the query.
     *
     * @param query the query of the close search.
     * @return the result of the search.
     */
    @GetMapping("/_search/closes")
    public Mono<List<CloseDTO>> searchCloses(@RequestParam String query) {
        log.debug("REST request to search Closes for query {}", query);
        return closeService.search(query).collectList();
    }
}
