...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
    ...
    public Mono<ResponseEntity<PaymentDTO>> getPayment(@PathVariable String id) {
    ...
    public Mono<List<PaymentDTO>> searchPayments(@RequestParam String query) {
        log.debug("REST request to search Payments for query {}", query);
        return paymentService.search(query).collectList();
    }
}
