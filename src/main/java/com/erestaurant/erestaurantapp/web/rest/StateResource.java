...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.State}.
 */
@RestController
@RequestMapping("/api")
public class StateResource {
    ...
    public Mono<List<StateDTO>> searchStates(@RequestParam String query) {
        log.debug("REST request to search States for query {}", query);
        return stateService.search(query).collectList();
    }
}
