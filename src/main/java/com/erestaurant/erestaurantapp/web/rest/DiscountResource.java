...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Discount}.
 */
@RestController
@RequestMapping("/api")
public class DiscountResource {
    ...
    public Mono<List<DiscountDTO>> searchDiscounts(@RequestParam String query) {
        log.debug("REST request to search Discounts for query {}", query);
        return discountService.search(query).collectList();
    }
}
