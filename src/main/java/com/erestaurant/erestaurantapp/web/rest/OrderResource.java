...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public Mono<List<OrderDTO>> searchOrders(@RequestParam String query) {
        log.debug("REST request to search Orders for query {}", query);
        return orderService.search(query).collectList();
    }
}
