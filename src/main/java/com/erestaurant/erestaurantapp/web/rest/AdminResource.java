...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Admin}.
 */
@RestController
@RequestMapping("/api")
public class AdminResource {
    ...
    public Mono<List<AdminDTO>> searchAdmins(@RequestParam String query) {
        log.debug("REST request to search Admins for query {}", query);
        return adminService.search(query).collectList();
    }
}
