...
/**
 * REST controller for managing {@link com.erestaurant.erestaurantapp.domain.Ad}.
 */
@RestController
@RequestMapping("/api")
public class AdResource {
    ...
    public Mono<List<AdDTO>> searchAds(@RequestParam String query) {
        log.debug("REST request to search Ads for query {}", query);
        return adService.search(query).collectList();
    }
}
