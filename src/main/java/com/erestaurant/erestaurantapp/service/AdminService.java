...
/**
 * Service Interface for managing {@link com.erestaurant.erestaurantapp.domain.Admin}.
 */
public interface AdminService {
    ...
    /**
     * Returns the number of admins available in search repository.
     *
     */
     ...
     * @return the list of entities.
     */
    Flux<AdminDTO> search(String query);
}
