...
@Configuration
@EnableR2dbcRepositories({ "com.erestaurant.erestaurantapp.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("com.erestaurant.erestaurantapp.repository.search")
